    ...
    def __init__(self,
        ...
        Initialize the dataset
            ...
            Args:
                ...
                sliding_step (int): Sliding step of the sliding window during the generation
                                    of input sequences
                ...
                bg_mode (str): Background mode
                    Choices:
                        ...
                        - 'subtract_concat': Return the frame sequence with RGB and difference 
                          frame channels
                ...
                padding (bool): Padding the last frame if the frame sequence is shorter than the
                                input sequence
