...
class BallTracker(Tracker):
    ...
    def __init__(
        ...
        tracknet_ckpt = torch.load(tracking_model_path, map_location=torch.device(self.DEVICE))
        ...
        if inpainting_model_path:
            inpaintnet_ckpt = torch.load(inpainting_model_path, map_location=torch.device(self.DEVICE))
